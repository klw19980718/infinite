    ...
    <section className="py-24 md:py-32 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          <a href="#multilingual-content" className="glass rounded-2xl p-8 hover:glass-strong hover:scale-[1.02] transition-all duration-300 cursor-pointer group">
          ...
          <a href="#infinitetalk" className="glass rounded-2xl p-8 hover:glass-strong hover:scale-[1.02] transition-all duration-300 cursor-pointer group">
          ...
          <a href="#shorts" className="glass rounded-2xl p-8 hover:glass-strong hover:scale-[1.02] transition-all duration-300 cursor-pointer group">
          ...
          <a href="#podcasts" className="glass rounded-2xl p-8 hover:glass-strong hover:scale-[1.02] transition-all duration-300 cursor-pointer group">
