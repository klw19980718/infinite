    ...
    <section className="py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          <a href="#multilingual-content" className="rounded-xl border border-border bg-card text-card-foreground p-6 transition cursor-pointer">
          ...
          <a href="#infinitetalk" className="rounded-xl border border-border bg-card text-card-foreground p-6 transition cursor-pointer">
          ...
          <a href="#shorts" className="rounded-xl border border-border bg-card text-card-foreground p-6 transition cursor-pointer">
          ...
          <a href="#podcasts" className="rounded-xl border border-border bg-card text-card-foreground p-6 transition cursor-pointer">
