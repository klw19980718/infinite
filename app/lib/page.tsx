        ...
        <article className="relative z-10 py-16 md:py-24">
          <div className="container mx-auto px-6 max-w-5xl">
            ...
            <header className="mb-12 md:mb-16 text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl glass border border-accent/60 mb-6">
                <BookOpen className="w-8 h-8 text-accent" />
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 text-balance">
                Documentation <span className="text-accent">Center</span>
              </h1>
              <div className="glass rounded-2xl p-6 md:p-8 border border-accent/60 max-w-3xl mx-auto">
              ...
              {documentationItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.id}
                    href={item.href}
                    className="group block glass rounded-2xl p-6 md:p-8 border border-accent/60 hover:border-accent transition-all duration-300 hover:shadow-xl"
                  >
                    <div className="flex items-start gap-4 md:gap-6">
                      <div className="flex-shrink-0 w-12 h-12 rounded-xl glass border border-accent/40 flex items-center justify-center group-hover:border-accent transition-colors">
            ...
            {documentationItems.length === 0 && (
              <section className="text-center py-16">
                <div className="glass rounded-2xl p-12 border border-accent/60 max-w-2xl mx-auto">
