...
export function PricingPageClient() {
  ...
  const plans = [
    {
      ...
      microcopy: "Approx. 1 min 40 s Standard or 50 s HD total.",
      cta: "Get Starter",
      popular: false,
    },
    {
      ...
      microcopy: "Approx. 4 min 10 s Standard or 2 min 5 s HD total.",
      cta: "Get Pro",
      popular: true,
    },
    {
      ...
      microcopy: "Approx. 10 min Standard or 5 min HD total.",
      cta: "Get Ultimate",
      popular: false,
    },
  ]
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Start with Starter to try it out. Choose Pro for the best balance. Pick Ultimate for the best value per credit.",
    },
    {
