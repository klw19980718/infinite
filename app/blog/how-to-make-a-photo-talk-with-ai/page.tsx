...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://cdn.infinitetalkai.org/blogs/talking-photo-demo-output-frame.webp',
        width: 1200,
        height: 630,
        alt: 'AI-generated talking photo demo showing a portrait animated to talk with lip sync',
      },
    ],
  },
  twitter: {
    ...
    title: 'How to Make a Photo Talk with AI | Infinite Talk AI',
    description: 'Learn how to make a photo talk with AI using Infinite Talk AI. Step-by-step workflow to animate a picture to talk, with lip sync and full-frame performance.',
    images: ['https://cdn.infinitetalkai.org/blogs/talking-photo-demo-output-frame.webp'],
  },
  robots: {
    index: true,
    follow: true,
...
export default function HowToMakePhotoTalkPage() {
  // Demo video metadata (approximately 8-12 seconds)
  const demoVideoUrl = 'https://cdn.infinitetalkai.org/blogs/make-photo-talk-ai-demo-video.mp4'
  const demoVideoPoster = 'https://cdn.infinitetalkai.org/blogs/talking-photo-demo-output-frame.webp'
  const inputImageUrl = 'https://cdn.infinitetalkai.org/blogs/talking-photo-input-portrait-before-ai.jpg.webp'
  
  // Comparison demo videos
  const mouthOnlyVideoUrl = 'https://cdn.infinitetalkai.org/blogs/mouth-only-talking-photo-lip-sync-demo.mp4'
  const mouthOnlyPoster = 'https://cdn.infinitetalkai.org/blogs/mouth-only-talking-photo-lip-sync-frame.webp'
  const fullFrameVideoUrl = 'https://cdn.infinitetalkai.org/blogs/full-frame-ai-talking-photo-demo.mp4'
  const fullFramePoster = 'https://cdn.infinitetalkai.org/blogs/full-frame-ai-talking-photo-demo-frame.webp'
    ...
    '@graph': [
      {
        ...
        mainEntityOfPage: {
          '@type': 'WebPage',
          '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai',
        },
        // 推荐把 image 写成 ImageObject（可选，但更规范）
        image: {
          '@type': 'ImageObject',
          url: demoVideoPoster,
        },
        ...
        // 让 Article 关联到下面的 VideoObject
        video: {
          '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai#video',
        },
      },
      {
        '@type': 'VideoObject',
        '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai#video',
        name: 'AI Talking Photo Demo - How to Make a Photo Talk with AI',
        description:
          'Demo video showing how Infinite Talk AI transforms a static portrait into a talking photo with natural lip sync, head motion, and facial expressions driven by audio.',
        thumbnailUrl: demoVideoPoster,
        uploadDate: '2025-01-27T00:00:00+00:00',
        duration: 'PT10S',
        contentUrl: demoVideoUrl,
        embedUrl: 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai',
        isPartOf: {
          '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai#article',
        },
        publisher: {
      ...
      {
        '@type': 'VideoObject',
        '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai#video-mouth-only',
        name: 'Mouth-Only Lip Sync Demo - Legacy Talking Photo Tools',
        description:
          'Comparison demo showing mouth-only lip sync where only the lips move and the rest of the face stays static, creating a talking sticker effect.',
        thumbnailUrl: mouthOnlyPoster,
        uploadDate: '2025-01-27T00:00:00+00:00',
        duration: 'PT10S',
        contentUrl: mouthOnlyVideoUrl,
        embedUrl: 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai',
        isPartOf: {
          '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai#article',
        },
      ...
      {
        '@type': 'VideoObject',
        '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai#video-full-frame',
        name: 'Full-Frame AI Talking Photo Demo - Infinite Talk AI',
        description:
          'Comparison demo showing full-frame AI talking photo where lips, eyes, head motion, and upper-body posture all react to the speech, creating a natural performance.',
        thumbnailUrl: fullFramePoster,
        uploadDate: '2025-01-27T00:00:00+00:00',
        duration: 'PT10S',
        contentUrl: fullFrameVideoUrl,
        embedUrl: 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai',
        isPartOf: {
          '@id': 'https://www.infinitetalkai.org/blog/how-to-make-a-photo-talk-with-ai#article',
        },
      ...
      <div className="min-h-screen pt-16 pb-20">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <article className="py-12 sm:py-16">
            ...
            {/* Hero: Input Photo + Demo Video */}
            <section className="mb-12" aria-label="Before and after demo">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                ...
                <figure className="space-y-3">
                  <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-border bg-muted/50">
                    <Image
                      src={inputImageUrl}
                      alt="Static input portrait before AI animation, a clear front-facing photo used to make a talking photo video with AI"
                      fill
                  ...
                  <figcaption className="text-sm text-muted-foreground text-center">
                    <strong className="text-foreground">Input:</strong> Single static portrait
                  </figcaption>
                </figure>
                ...
                <figure className="space-y-3">
                  <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-border bg-muted/50">
                    <video
                      ...
                      aria-label="Demo video of an AI-generated talking photo from a single image and audio, with natural lip sync, head motion, and facial expressions"
                    >
                  ...
                  <figcaption className="text-sm text-muted-foreground text-center">
                    <strong className="text-foreground">Output:</strong> AI-generated talking photo
                  </figcaption>
                </figure>
            ...
            <BlogPostContent headings={headings}>
              ...
              <section className="mb-12">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                  ...
                  {/* Comparison: Mouth-only vs Full-frame */}
                  <div className="mt-8 grid gap-6 md:grid-cols-2">
                    {/* Mouth-only demo */}
                    <figure className="space-y-2">
                      <h3 className="text-sm font-semibold text-foreground">
                        Mouth-only lip sync (legacy tools)
                      </h3>
                      <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-border bg-black">
                        <video
                          controls
                          preload="metadata"
                          poster={mouthOnlyPoster}
                          className="h-full w-full object-cover"
                          aria-label="Mouth-only talking photo demo where only the lips move and the rest of the face stays static"
                        >
                          <source src={mouthOnlyVideoUrl} type="video/mp4" />
                          Your browser does not support the video tag.
                        </video>
                      </div>
                      <figcaption className="text-xs text-muted-foreground">
                        Only the lips move. The head, eyes, and posture stay almost frozen, which quickly feels like a talking sticker.
                      </figcaption>
                    </figure>
                    ...
                    <figure className="space-y-2">
                      <h3 className="text-sm font-semibold text-foreground">
                        Full-frame AI talking photo (Infinite Talk AI)
                      </h3>
                      <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-border bg-black">
                        <video
                          controls
                          preload="metadata"
                          poster={fullFramePoster}
                          className="h-full w-full object-cover"
                          aria-label="Full-frame AI talking photo demo from a single image and audio, with natural lip sync, head motion, and expressions"
                        >
                          <source src={fullFrameVideoUrl} type="video/mp4" />
                          Your browser does not support the video tag.
                        </video>
                      </div>
                      <figcaption className="text-xs text-muted-foreground">
                        Lips, eyes, head motion, and upper-body posture all react to the speech, so the talking photo feels like a real performance.
                      </figcaption>
                    </figure>
                  </div>
                </div>
              ...
              <section className="mb-12">
                ...
                <figure className="my-4 space-y-2 mb-6">
                  <div className="relative w-full rounded-xl border border-border bg-muted/40 overflow-hidden aspect-video max-w-3xl mx-auto">
                    <Image
                      src="https://cdn.infinitetalkai.org/blogs/talking-photo-workflow-ui-screenshot.png"
                      alt="Screenshot of the Infinite Talk AI Talking Photo workflow with image and audio upload fields"
                      fill
                      className="object-cover"
                      loading="lazy"
                  ...
                  <figcaption className="text-xs text-muted-foreground text-center">
                    Talking Photo workflow in Infinite Talk AI: upload a single image, add your audio, then generate a talking photo video.
                  </figcaption>
                </figure>
